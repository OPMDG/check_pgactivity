...
The following packages have to be installed:
 perl-Pod-Parser-1.67-6.fc43.noarch	Basic perl modules for handling Plain Old Documentation (POD)
...
check_pgactivity version 2.9, released on Tue Feb 17 2026.
