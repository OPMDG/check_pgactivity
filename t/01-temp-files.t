...
SKIP: {
    ...
    $node->command_checks_all( [
        ...
        [ qr/^Service  *: POSTGRES_TEMP_FILES$/m,
          ...
          qr/^Perfdata *: postgres=[1-9][.0-9]*[kMGTPE]*B warn=200.00kB crit=300.00kB$/m,
          qr/^Perfdata *: template1=[1-9][.0-9]*Fpm$/m,
          qr/^Perfdata *: template1=[1-9][.0-9]*[kMGTPE]*Bpm$/m,
          qr/^Perfdata *: template1=[1-9][0-9]*Files$/m,
          qr/^Perfdata *: template1=[1-9][.0-9]*[kMGTPE]*B warn=200.00kB crit=300.00kB$/m,
        ],
        [ qr/^$/ ],
        'test file size OK'
    );
    ...
    $node->command_checks_all( [
        ...
        [ qr/^Service  *: POSTGRES_TEMP_FILES$/m,
          ...
          qr/^Perfdata *: postgres=[1-9][.0-9]*[kMGTPE]*Bpm$/m,
          qr/^Perfdata *: postgres=[1-9][0-9]*Files$/m,
          qr/^Perfdata *: postgres=[1-9][.0-9]*[kMGTPE]*B warn=100.00kB crit=200.00kB$/m,
          qr/^Perfdata *: template1=[1-9][.0-9]*Fpm$/m,
          qr/^Perfdata *: template1=[1-9][.0-9]*[kMGTPE]*Bpm$/m,
          qr/^Perfdata *: template1=[1-9][0-9]*Files$/m,
          qr/^Perfdata *: template1=[1-9][.0-9]*[kMGTPE]*B warn=100.00kB crit=200.00kB$/m,
        ],
        [ qr/^$/ ],
        'test file size WARN'
    );
    ...
    $node->command_checks_all( [
        ...
        [ qr/^Service  *: POSTGRES_TEMP_FILES$/m,
          ...
          qr/^Perfdata *: postgres=[1-9][.0-9]*[kMGTPE]*Bpm$/m,
          qr/^Perfdata *: postgres=[1-9][0-9]*Files$/m,
          qr/^Perfdata *: postgres=[1-9][.0-9]*[kMGTPE]*B warn=50.00kB crit=100.00kB$/m,
          qr/^Perfdata *: template1=[1-9][.0-9]*Fpm$/m,
          qr/^Perfdata *: template1=[1-9][.0-9]*[kMGTPE]*Bpm$/m,
          qr/^Perfdata *: template1=[1-9][0-9]*Files$/m,
          qr/^Perfdata *: template1=[1-9][.0-9]*[kMGTPE]*B warn=50.00kB crit=100.00kB$/m,
        ],
        [ qr/^$/ ],
        'test file count CRIT'
    );
    ...
    $node->command_checks_all( [
        ...
        [ qr/^Service  *: POSTGRES_TEMP_FILES$/m,
          ...
          qr/^Perfdata *: postgres=[1-9][.0-9]*[kMGTPE]*Bpm$/m,
          qr/^Perfdata *: postgres=[1-9][0-9]*Files warn=3 crit=4$/m,
          qr/^Perfdata *: postgres=[1-9][.0-9]*[kMGTPE]*B warn=48.10MB crit=64.10MB$/m,
          qr/^Perfdata *: template1=[1-9][.0-9]*Fpm$/m,
          qr/^Perfdata *: template1=[1-9][.0-9]*[kMGTPE]*Bpm$/m,
          qr/^Perfdata *: template1=[1-9][0-9]*Files warn=3 crit=4$/m,
          qr/^Perfdata *: template1=[1-9][.0-9]*[kMGTPE]*B warn=48.10MB crit=64.10MB$/m,
        ],
        [ qr/^$/ ],
    ...
    $node->command_checks_all( [
        ...
        [ qr/^Service  *: POSTGRES_TEMP_FILES$/m,
          ...
          qr/^Perfdata *: postgres=[1-9][.0-9]*Fpm$/m,
          qr/^Perfdata *: Total size in myts2=8.00kB$/m,
          qr/^Perfdata *: postgres=[1-9][.0-9]*Fpm$/m,
          qr/^Perfdata *: postgres=[1-9][.0-9]*[kMGTPE]*Bpm$/m,
          qr/^Perfdata *: postgres=[1-9][0-9]*Files$/m,
          qr/^Perfdata *: postgres=[1-9][.0-9]*[kMGTPE]*B$/m,
