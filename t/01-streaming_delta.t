...
SKIP: {
    ...
    $prim->command_checks_all( [
        ...
        [
            ...
            qr/Perfdata *: sent delta sec1@=0.00B$/m,
            qr/Perfdata *: wrote delta sec1@=0.00B$/m,
            qr/Perfdata *: flushed delta sec1@=0.00B$/m,
            qr/Perfdata *: replay delta sec1@=0.00B$/m,
            qr/Perfdata *: pid sec1@=\d+$/m,
            qr/Perfdata *: sent delta sec2@=0.00B$/m,
            qr/Perfdata *: wrote delta sec2@=0.00B$/m,
            qr/Perfdata *: flushed delta sec2@=0.00B$/m,
            qr/Perfdata *: replay delta sec2@=0.00B$/m,
    ...
    $prim->command_checks_all( [
        ...
        [
            ...
            qr/Message  *: warning flush lag: 2.00MB for sec1\@$/m,
            qr/Perfdata *: sent delta sec1@=0.00B$/m,
            qr/Perfdata *: wrote delta sec1@=1024.00kB$/m,
            qr/Perfdata *: flushed delta sec1@=2.00MB warn=512.00B crit=4.00MB$/m,
            qr/Perfdata *: replay delta sec1@=3.00MB warn=4.00MB crit=4.00MB$/m,
            qr/Perfdata *: pid sec1@=\d+$/m,
            qr/Perfdata *: # of excluded slaves=0$/m,
            qr/Perfdata *: # of slaves=1$/m
        ],
    ...
    $prim->command_checks_all( [
        ...
        [
            qr/Service  *: POSTGRES_STREAMING_DELTA$/m,
            qr/Returns  *: 2 \(CRITICAL\)$/m,
            qr/Message  *: critical flush lag: 2.00MB for sec1\@$/m,
            qr/Perfdata *: sent delta sec1@=0.00B$/m,
            qr/Perfdata *: wrote delta sec1@=1024.00kB$/m,
            qr/Perfdata *: flushed delta sec1@=2.00MB warn=512.00B crit=1024.00kB$/m,
            qr/Perfdata *: replay delta sec1@=3.00MB warn=4.00MB crit=4.00MB$/m,
            qr/Perfdata *: pid sec1@=\d+$/m,
            qr/Perfdata *: # of excluded slaves=0$/m,
            qr/Perfdata *: # of slaves=1$/m
    ...
    $prim->command_checks_all( [
        ...
        [
            qr/Service  *: POSTGRES_STREAMING_DELTA$/m,
            qr/Returns  *: 1 \(WARNING\)$/m,
            qr/Message  *: warning replay lag: 3.00MB for sec1\@$/m,
            qr/Perfdata *: sent delta sec1@=0.00B$/m,
            qr/Perfdata *: wrote delta sec1@=1024.00kB$/m,
            qr/Perfdata *: flushed delta sec1@=2.00MB warn=3.00MB crit=4.00MB$/m,
            qr/Perfdata *: replay delta sec1@=3.00MB warn=512.00B crit=4.00MB$/m,
            qr/Perfdata *: pid sec1@=\d+$/m,
            qr/Perfdata *: # of excluded slaves=0$/m,
            qr/Perfdata *: # of slaves=1$/m
        ],
    ...
    $prim->command_checks_all( [
        ...
        [
            qr/Service  *: POSTGRES_STREAMING_DELTA$/m,
            qr/Returns  *: 2 \(CRITICAL\)$/m,
            qr/Message  *: critical replay lag: 3.00MB for sec1\@$/m,
            qr/Perfdata *: sent delta sec1@=0.00B$/m,
            qr/Perfdata *: wrote delta sec1@=1024.00kB$/m,
            qr/Perfdata *: flushed delta sec1@=2.00MB warn=3.00MB crit=4.00MB$/m,
            qr/Perfdata *: replay delta sec1@=3.00MB warn=512.00B crit=2.00MB$/m,
            qr/Perfdata *: pid sec1@=\d+$/m,
            qr/Perfdata *: # of excluded slaves=0$/m,
            qr/Perfdata *: # of slaves=1$/m
        ],
